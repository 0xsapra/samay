...
class samay:
    ...
    def set(self,val,time):
        ...
        if time == "min" or time=="minute" or time=="minutes" or time=="m":
            self.mtime =  self.mtime.replace(minute = val)
        elif time == "hour" or time=="hours" or time=="h":
            self.mtime =  self.mtime.replace(hour = val)
        elif time == "day" or time=="days" or time=="d":
            self.mtime =  self.mtime.replace(day = val)
        elif time == "month" or time=="M":
            self.mtime =  self.mtime.replace(month = val)
        elif time == "year" or time=="y":
            self.mtime =  self.mtime.replace(year = val)
        elif time == "sec" or time=="s" or time=="second":
            self.mtime =  self.mtime.replace(second = val)
